        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center ${currentStyle.iconBg}`}
              >
          ...
          <div className="flex justify-end gap-3 p-6 border-t border-gray-200">
            ...
            <button
              onClick={onConfirm}
              className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${currentStyle.confirmBg} ${currentStyle.confirmText}`}
            >
              {confirmText}
            </button>
          </div>
